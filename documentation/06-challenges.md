...
Before navigating, save currentTime, playing, and savedAt to sessionStorage
On the next page, read the saved state and seek bgMusic.currentTime to the saved position
If the state is older than 30 seconds, start from zero
...
### Solution
Moved require_once i18n.php and $current_lang refresh to the top of settings_panel.php
Added every settings-panel key to all 5 language arrays in i18n.php
Called __() inline in the HTML instead of pre-computing a $lang array
