...
$GLOBAL_TRANSLATIONS = [
    ...
    'en' => [
        ...
        'two_fa_enabled_detail' => 'Your account is protected with email OTP on every login.',
        'two_fa_disabled_detail' => 'Enable 2FA in settings for extra security.',
        'password_last_changed' => 'Password Last Changed',
        'password_today' => 'Today',
        'password_yesterday' => '1 day ago',
        'password_days_ago' => 'days ago',
        'password_unknown' => 'Unknown — consider updating',
        'password_stale' => 'days ago — consider refreshing',
        'trusted_devices' => 'Trusted Devices',
        'trusted_none' => 'No devices with "stay signed in"',
        'trusted_one' => '1 device has an active remember-me token',
        'trusted_many' => 'devices have active remember-me tokens',
        'favorite_games' => 'Favorite Games',
        'favorites_empty' => 'No favorite games yet.',
        'favorites_empty_hint' => 'Tap the heart on any game to save it here.',
        'playtime_summary' => 'Play Time Summary',
    ...
    'tl' => [
        ...
        'two_fa_status' => 'Two-Factor Authentication',
        'two_fa_enabled' => 'Aktibo',
        'two_fa_disabled' => 'Hindi Aktibo',
        'two_fa_enabled_detail' => 'Protektado ang account mo gamit ang email OTP sa bawat login.',
        'two_fa_disabled_detail' => 'I-enable ang 2FA sa settings para sa dagdag na seguridad.',
        'password_last_changed' => 'Huling Palit ng Password',
        'password_today' => 'Ngayon',
        'password_yesterday' => '1 araw na nakalipas',
        'password_days_ago' => 'araw na nakalipas',
        'password_unknown' => 'Hindi alam — isaalang-alang ang pag-update',
        'password_stale' => 'araw na nakalipas — isaalang-alang ang pag-refresh',
        'trusted_devices' => 'Mga Pinagkakatiwalaang Device',
        'trusted_none' => 'Walang device na may "stay signed in"',
        'trusted_one' => '1 device ang may aktibong remember-me token',
        'trusted_many' => 'device ang may aktibong remember-me token',
        'favorite_games' => 'Paboritong Laro',
        'favorites_empty' => 'Wala pang paboritong laro.',
        'favorites_empty_hint' => 'I-tap ang puso sa kahit anong laro para i-save dito.',
        'playtime_summary' => 'Buod ng Oras ng Paglalaro',
        'total_played' => 'Kabuuang Nilaro',
        'sessions' => 'Mga Session',
        'avg_session' => 'Average na Session',
    ],
    ...
    'es' => [
        ...
        'two_fa_status' => 'Autenticación 2FA',
        'two_fa_enabled' => 'Activada',
        'two_fa_disabled' => 'Desactivada',
        'two_fa_enabled_detail' => 'Tu cuenta está protegida con OTP por correo en cada inicio.',
        'two_fa_disabled_detail' => 'Activa 2FA en ajustes para mayor seguridad.',
        'password_last_changed' => 'Último Cambio de Contraseña',
        'password_today' => 'Hoy',
        'password_yesterday' => 'Hace 1 día',
        'password_days_ago' => 'días atrás',
        'password_unknown' => 'Desconocido — considera actualizar',
        'password_stale' => 'días atrás — considera renovar',
        'trusted_devices' => 'Dispositivos de Confianza',
        'trusted_none' => 'Ningún dispositivo con "mantener sesión iniciada"',
        'trusted_one' => '1 dispositivo tiene un token activo',
        'trusted_many' => 'dispositivos tienen tokens activos',
        'favorite_games' => 'Juegos Favoritos',
        'favorites_empty' => 'Aún no tienes juegos favoritos.',
        'favorites_empty_hint' => 'Toca el corazón en cualquier juego para guardarlo aquí.',
        'playtime_summary' => 'Resumen de Tiempo',
    ...
    'ja' => [
        ...
        'two_fa_enabled' => '有効',
        'two_fa_disabled' => '無効',
        'two_fa_enabled_detail' => 'ログインのたびにメールOTPで保護されています。',
        'two_fa_disabled_detail' => '設定で2FAを有効にしてセキュリティを強化してください。',
        'password_last_changed' => 'パスワード最終変更',
        'password_today' => '今日',
        'password_yesterday' => '1日前',
        'password_days_ago' => '日前',
        'password_unknown' => '不明 — 更新を検討してください',
        'password_stale' => '日前 — 更新を検討してください',
        'trusted_devices' => '信頼できるデバイス',
        'trusted_none' => '「ログイン状態を保持」のデバイスはありません',
        'trusted_one' => '1台のデバイスにアクティブなトークンがあります',
        'trusted_many' => '台のデバイスにアクティブなトークンがあります',
        'favorite_games' => 'お気に入りのゲーム',
        'favorites_empty' => 'まだお気に入りのゲームはありません。',
        'favorites_empty_hint' => 'ゲームのハートをタップしてここに保存します。',
        'playtime_summary' => 'プレイ時間の概要',
        'total_played' => '合計プレイ時間',
        'sessions' => 'セッション',
        'avg_session' => '平均セッション',
    ],
    ...
    'ko' => [
        ...
        'two_fa_status' => '2단계 인증',
        'two_fa_enabled' => '활성화됨',
        'two_fa_disabled' => '비활성화됨',
        'two_fa_enabled_detail' => '모든 로그인 시 이메일 OTP로 계정이 보호됩니다.',
        'two_fa_disabled_detail' => '설정에서 2FA를 활성화하여 보안을 강화하세요.',
        'password_last_changed' => '마지막 비밀번호 변경',
        'password_today' => '오늘',
        'password_yesterday' => '1일 전',
        'password_days_ago' => '일 전',
        'password_unknown' => '알 수 없음 — 업데이트를 고려하세요',
        'password_stale' => '일 전 — 새로 고침을 고려하세요',
        'trusted_devices' => '신뢰할 수 있는 기기',
        'trusted_none' => '"로그인 상태 유지"를 사용하는 기기가 없습니다',
        'trusted_one' => '1개의 기기에 활성 토큰이 있습니다',
        'trusted_many' => '개의 기기에 활성 토큰이 있습니다',
        'favorite_games' => '즐겨찾는 게임',
        'favorites_empty' => '아직 즐겨찾는 게임이 없습니다.',
        'favorites_empty_hint' => '게임의 하트를 눌러 여기에 저장하세요.',
        'playtime_summary' => '플레이 시간 요약',
        'total_played' => '총 플레이 시간',
        'sessions' => '세션',
        'avg_session' => '평균 세션',
    ],
];
